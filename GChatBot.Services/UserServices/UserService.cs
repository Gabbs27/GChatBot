...
public class UserService : BaseDbServices<User>, IUserService
{
    ...
    public UserService(IDbContextFactory<GChatBotDbContext> dbContextFactory, SignInManager<User>? signInManager = null, UserManager<User>? userManager = null) : base(dbContextFactory)
    {
